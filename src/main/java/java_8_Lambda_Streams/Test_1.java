...
public class Test_1 {
    /**
     * What is lambda ->
     * a) Lambda is equivalent to a function(method) without a name.
     * b) Lambdas are also referred as Anonymous functions.  Lambda has all Qualities like regular method, such As :
     * 1) Method parameters
     * 2) Method Body
     * 3) return Type
